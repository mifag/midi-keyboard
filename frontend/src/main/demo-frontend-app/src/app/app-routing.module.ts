...
import { UpdateMidiKeyboardComponent } from './midi-keyboard/view-midi-keyboard/update-midi-keyboard/update.midi.keyboard.component';
...
const routes: Routes = [
  ...
  {
    path: 'midi-keyboard/update/:id',
    component: UpdateMidiKeyboardComponent
  }
];
